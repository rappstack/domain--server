...
export const jsonld_Graph_ = ns_id_be_('app', 'site__jsonld_Graph', (ctx:request_ctx_T)=>{
	return <Graph>{
		'@context': 'https://schema.org',
		'@graph': [...app_jsonld_Thing_S_(ctx), ...jsonld_Thing_S_(ctx)]
	}
})
const app_jsonld_Thing_S_ = ns_id_be_('app', 'app_jsonld_thing_S', ctx=>
	new Set<Thing>())
...
const jsonld_Thing_S_ = id_be_('jsonld_thing_S', ctx=>
	new Set<Thing>())
